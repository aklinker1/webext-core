...
A set of core libraries and tools for building web extensions. These libraries
are built on top of
...
- [`@webext-core/messaging`](https://webext-core.aklinker1.io/messaging/installation):
  Light weight, type-safe wrapper around the web extension messaging APIs
- [`@webext-core/storage`](https://webext-core.aklinker1.io/storage/installation):
...
- [`@webext-core/job-scheduler`](https://webext-core.aklinker1.io/job-scheduler/installation):
  Schedule reoccuring jobs using the Alarms API
...
- [`@webext-core/isolated-element`](https://webext-core.aklinker1.io/isolated-element/installation):
  Isolate content script UIs from the page's styles

## Documentation

To get started, checkout the
[documentation website](https://webext-core.aklinker1.io).

## Contributors

Published under the
[MIT](https://github.com/aklinker1/webext-core/blob/main/LICENSE) license. Made
by [@aklinker1](https://github.com/aklinker1) and
[community](https://github.com/aklinker1/webext-core/graphs/contributors) 💛
