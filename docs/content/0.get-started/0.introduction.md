...
All of `@webext-core` NPM packages include a minified, `dist/index.iife.js` file that will create a global variable you can use to access the package's APIs.
...
curl -o vendor/webext-core/storage.js https://cdn.jsdelivr.net/npm/@webext-core/storage/dist/index.iife.js
```
