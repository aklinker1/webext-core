...
Now that you have a service implemented, we need to tell the extension to use it! This needs to happen synchronously when your background script is loaded, so put it as high up as possible.
