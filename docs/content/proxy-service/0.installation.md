...
```bash
curl -o proxy-service.js https://cdn.jsdelivr.net/npm/@webext-core/proxy-service/dist/index.iife.js
```
...
First, we need to implement our service. In this case, the service will contain CRUD operations for todos in the database:
